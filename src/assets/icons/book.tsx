...
export function BookIcon({ className }: SvgIconProps): JSX.Element {
    return (
        <svg
            className={className}
            fill='none'
