    ...
    return (
        <main className='mx-auto w-full max-w-3xl'>
            ...
            <div className='flex flex-col items-center gap-6'>
                        ...
                        >
                            ...
                            <Label
                                className={cn(
                                    ...
                                    friend && '-top-1 px-2 text-foreground'
                                )}
                            ...
                            <Button
                                className='absolute right-0 top-0 h-6 rounded-md rounded-r-none rounded-t-none border-b border-l border-primary bg-background px-3'
                                onClick={() => {
                                    handleDelete(index);
                                }}
                                variant='ghost'
                            ...
                            {studentNames.at(index) && (
                                <Label
                                    className='pointer-events-none absolute -bottom-6 left-4 text-muted-foreground'
                                    htmlFor='student-id'
                                >
                                    {studentNames.at(index)}
                                </Label>
                ...
                <Button
                    className='size-6 rounded-full bg-primary text-white'
                    onClick={handleAdd}
                >
                    +
                </Button>
